...
class PersonImageVersionTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'File', 'PersonId', 'CreatedAt', 'UpdatedAt', 'Version', 'VersionCreatedAt', 'VersionCreatedBy', 'PersonIdVersion', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'file', 'personId', 'createdAt', 'updatedAt', 'version', 'versionCreatedAt', 'versionCreatedBy', 'personIdVersion', ),
        ...
        self::TYPE_RAW_COLNAME   => array('ID', 'FILE', 'PERSON_ID', 'CREATED_AT', 'UPDATED_AT', 'VERSION', 'VERSION_CREATED_AT', 'VERSION_CREATED_BY', 'PERSON_ID_VERSION', ),
        self::TYPE_FIELDNAME     => array('id', 'file', 'person_id', 'created_at', 'updated_at', 'version', 'version_created_at', 'version_created_by', 'person_id_version', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'File' => 1, 'PersonId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Version' => 5, 'VersionCreatedAt' => 6, 'VersionCreatedBy' => 7, 'PersonIdVersion' => 8, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'file' => 1, 'personId' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'version' => 5, 'versionCreatedAt' => 6, 'versionCreatedBy' => 7, 'personIdVersion' => 8, ),
        self::TYPE_COLNAME       => array(PersonImageVersionTableMap::ID => 0, PersonImageVersionTableMap::FILE => 1, PersonImageVersionTableMap::PERSON_ID => 2, PersonImageVersionTableMap::CREATED_AT => 3, PersonImageVersionTableMap::UPDATED_AT => 4, PersonImageVersionTableMap::VERSION => 5, PersonImageVersionTableMap::VERSION_CREATED_AT => 6, PersonImageVersionTableMap::VERSION_CREATED_BY => 7, PersonImageVersionTableMap::PERSON_ID_VERSION => 8, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'FILE' => 1, 'PERSON_ID' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'VERSION' => 5, 'VERSION_CREATED_AT' => 6, 'VERSION_CREATED_BY' => 7, 'PERSON_ID_VERSION' => 8, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'file' => 1, 'person_id' => 2, 'created_at' => 3, 'updated_at' => 4, 'version' => 5, 'version_created_at' => 6, 'version_created_by' => 7, 'person_id_version' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
