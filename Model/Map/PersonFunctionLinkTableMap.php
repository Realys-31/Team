...
/**
 * This class defines the structure of the 'person_function_link' table.
 *
 *
 *
 ...
 *
 */
class PersonFunctionLinkTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Team.Model.Map.PersonFunctionLinkTableMap';
     ...
     */
    const TABLE_NAME = 'person_function_link';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Team\\Model\\PersonFunctionLink';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Team.Model.PersonFunctionLink';
     ...
     */
    const ID = 'person_function_link.ID';

    /**
     * the column name for the PERSON_ID field
     */
    const PERSON_ID = 'person_function_link.PERSON_ID';

    /**
     * the column name for the FUNCTION_ID field
     */
    const FUNCTION_ID = 'person_function_link.FUNCTION_ID';

    /**
     * the column name for the CREATED_AT field
     */
    const CREATED_AT = 'person_function_link.CREATED_AT';
    ...
    {
        // attributes
        $this->setName('person_function_link');
        $this->setPhpName('PersonFunctionLink');
        $this->setClassName('\\Team\\Model\\PersonFunctionLink');
    ...
    {
        return $withPrefix ? PersonFunctionLinkTableMap::CLASS_DEFAULT : PersonFunctionLinkTableMap::OM_CLASS;
    }
     ...
     * @return array (PersonFunctionLink object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = PersonFunctionLinkTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = PersonFunctionLinkTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + PersonFunctionLinkTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PersonFunctionLinkTableMap::OM_CLASS;
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            PersonFunctionLinkTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = PersonFunctionLinkTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = PersonFunctionLinkTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PersonFunctionLinkTableMap::ID);
            $criteria->addSelectColumn(PersonFunctionLinkTableMap::PERSON_ID);
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(PersonFunctionLinkTableMap::DATABASE_NAME)->getTable(PersonFunctionLinkTableMap::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getServiceContainer()->getDatabaseMap(PersonFunctionLinkTableMap::DATABASE_NAME);
      if (!$dbMap->hasTable(PersonFunctionLinkTableMap::TABLE_NAME)) {
        $dbMap->addTableObject(new PersonFunctionLinkTableMap());
      }
    }

    /**
     * Performs a DELETE on the database, given a PersonFunctionLink or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or PersonFunctionLink object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Team\Model\PersonFunctionLink) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PersonFunctionLinkTableMap::DATABASE_NAME);
            $criteria->add(PersonFunctionLinkTableMap::ID, (array) $values, Criteria::IN);
        }

        $query = PersonFunctionLinkQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { PersonFunctionLinkTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { PersonFunctionLinkTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return PersonFunctionLinkQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a PersonFunctionLink or Criteria object.
     *
     * @param mixed               $criteria Criteria or PersonFunctionLink object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from PersonFunctionLink object
        }

        if ($criteria->containsKey(PersonFunctionLinkTableMap::ID) && $criteria->keyContainsValue(PersonFunctionLinkTableMap::ID) ) {
...
} // PersonFunctionLinkTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
PersonFunctionLinkTableMap::buildTableMap();
