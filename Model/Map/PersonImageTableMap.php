...
class PersonImageTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'File', 'PersonId', 'CreatedAt', 'UpdatedAt', 'Version', 'VersionCreatedAt', 'VersionCreatedBy', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'file', 'personId', 'createdAt', 'updatedAt', 'version', 'versionCreatedAt', 'versionCreatedBy', ),
        self::TYPE_COLNAME       => array(PersonImageTableMap::ID, PersonImageTableMap::FILE, PersonImageTableMap::PERSON_ID, PersonImageTableMap::CREATED_AT, PersonImageTableMap::UPDATED_AT, PersonImageTableMap::VERSION, PersonImageTableMap::VERSION_CREATED_AT, PersonImageTableMap::VERSION_CREATED_BY, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'FILE', 'PERSON_ID', 'CREATED_AT', 'UPDATED_AT', 'VERSION', 'VERSION_CREATED_AT', 'VERSION_CREATED_BY', ),
        self::TYPE_FIELDNAME     => array('id', 'file', 'person_id', 'created_at', 'updated_at', 'version', 'version_created_at', 'version_created_by', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'File' => 1, 'PersonId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Version' => 5, 'VersionCreatedAt' => 6, 'VersionCreatedBy' => 7, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'file' => 1, 'personId' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'version' => 5, 'versionCreatedAt' => 6, 'versionCreatedBy' => 7, ),
        self::TYPE_COLNAME       => array(PersonImageTableMap::ID => 0, PersonImageTableMap::FILE => 1, PersonImageTableMap::PERSON_ID => 2, PersonImageTableMap::CREATED_AT => 3, PersonImageTableMap::UPDATED_AT => 4, PersonImageTableMap::VERSION => 5, PersonImageTableMap::VERSION_CREATED_AT => 6, PersonImageTableMap::VERSION_CREATED_BY => 7, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'FILE' => 1, 'PERSON_ID' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'VERSION' => 5, 'VERSION_CREATED_AT' => 6, 'VERSION_CREATED_BY' => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'file' => 1, 'person_id' => 2, 'created_at' => 3, 'updated_at' => 4, 'version' => 5, 'version_created_at' => 6, 'version_created_by' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
