...
/**
 * Base class that represents a query for the 'person_team_link' table.
 *
 *
 *
 * @method     ChildPersonTeamLinkQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildPersonTeamLinkQuery orderByPersonId($order = Criteria::ASC) Order by the person_id column
 ...
 * @method     ChildPersonTeamLinkQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildPersonTeamLinkQuery leftJoinPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person relation
 * @method     ChildPersonTeamLinkQuery rightJoinPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person relation
 * @method     ChildPersonTeamLinkQuery innerJoinPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the Person relation
 *
 * @method     ChildPersonTeamLinkQuery leftJoinTeam($relationAlias = null) Adds a LEFT JOIN clause to the query using the Team relation
 ...
 *
 * @method     ChildPersonTeamLink findOneById(int $id) Return the first ChildPersonTeamLink filtered by the id column
 * @method     ChildPersonTeamLink findOneByPersonId(int $person_id) Return the first ChildPersonTeamLink filtered by the person_id column
...
abstract class PersonTeamLinkQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'thelia', $modelName = '\\Team\\Model\\PersonTeamLink', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildPersonTeamLinkQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildPersonTeamLinkQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof \Team\Model\PersonTeamLinkQuery) {
            return $criteria;
        }
        $query = new \Team\Model\PersonTeamLinkQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildPersonTeamLink|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = PersonTeamLinkTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return   ChildPersonTeamLink A model object, or null if the key is not found
     */
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            $obj = new ChildPersonTeamLink();
            $obj->hydrate($row);
            PersonTeamLinkTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::ID, $id, $comparison);
    }
    ...
    public function filterByPersonId($personId = null, $comparison = null)
    {
        if (is_array($personId)) {
            ...
            if (isset($personId['min'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::PERSON_ID, $personId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($personId['max'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::PERSON_ID, $personId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::PERSON_ID, $personId, $comparison);
    }
    ...
    public function filterByTeamId($teamId = null, $comparison = null)
    {
        if (is_array($teamId)) {
            $useMinMax = false;
            if (isset($teamId['min'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::TEAM_ID, $teamId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($teamId['max'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::TEAM_ID, $teamId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::TEAM_ID, $teamId, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PersonTeamLinkTableMap::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonTeamLinkTableMap::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \Team\Model\Person) {
            return $this
                ->addUsingAlias(PersonTeamLinkTableMap::PERSON_ID, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PersonTeamLinkTableMap::PERSON_ID, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByTeam($team, $comparison = null)
    {
        if ($team instanceof \Team\Model\Team) {
            return $this
                ->addUsingAlias(PersonTeamLinkTableMap::TEAM_ID, $team->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PersonTeamLinkTableMap::TEAM_ID, $team->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildPersonTeamLink $personTeamLink Object to remove from the list of results
     *
     * @return ChildPersonTeamLinkQuery The current query, for fluid interface
     */
    public function prune($personTeamLink = null)
    {
        if ($personTeamLink) {
            $this->addUsingAlias(PersonTeamLinkTableMap::ID, $personTeamLink->getId(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            PersonTeamLinkTableMap::clearRelatedInstancePool();
    ...
    /**
     * Performs a DELETE on the database, given a ChildPersonTeamLink or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ChildPersonTeamLink object or primary key or array of primary keys
     ...
     */
     public function delete(ConnectionInterface $con = null)
     {
        ...
        $criteria->setDbName(PersonTeamLinkTableMap::DATABASE_NAME);
        ...
        PersonTeamLinkTableMap::removeInstanceFromPool($criteria);
    ...
    {
        return $this->addUsingAlias(PersonTeamLinkTableMap::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addUsingAlias(PersonTeamLinkTableMap::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PersonTeamLinkTableMap::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PersonTeamLinkTableMap::UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PersonTeamLinkTableMap::CREATED_AT);
    }
