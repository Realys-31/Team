...
abstract class PersonImageVersion implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PersonImageVersionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PersonImageVersionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PersonImageVersionTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PersonImageVersionTableMap::translateFieldName('VersionCreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->version_created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PersonImageVersionTableMap::translateFieldName('VersionCreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version_created_by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : PersonImageVersionTableMap::translateFieldName('PersonIdVersion', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = PersonImageVersionTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aPersonImage !== null && $this->id !== $this->aPersonImage->getId()) {
            $this->aPersonImage = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPersonImage !== null) {
                if ($this->aPersonImage->isModified() || $this->aPersonImage->isNew()) {
                    $affectedRows += $this->aPersonImage->save($con);
                }
                $this->setPersonImage($this->aPersonImage);
            }
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPersonImage) {
                $result['PersonImage'] = $this->aPersonImage->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Get the associated ChildPersonImage object
     *
     * @param      ConnectionInterface $con Optional Connection object.
     * @return                 ChildPersonImage The associated ChildPersonImage object.
     * @throws PropelException
     */
    public function getPersonImage(ConnectionInterface $con = null)
    {
        if ($this->aPersonImage === null && ($this->id !== null)) {
            $this->aPersonImage = ChildPersonImageQuery::create()->findPk($this->id, $con);
