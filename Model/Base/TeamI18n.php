...
abstract class TeamI18n implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Team\\Model\\Map\\TeamI18nTableMap';
    ...
    /**
     * Initializes internal state of Team\Model\Base\TeamI18n object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>TeamI18n</code> instance.  If
     * <code>obj</code> is an instance of <code>TeamI18n</code>, delegates to
     * <code>equals(TeamI18n)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return TeamI18n The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TeamI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[TeamI18nTableMap::LOCALE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[TeamI18nTableMap::DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TeamI18nTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTeamI18nQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TeamI18n::setDeleted()
     * @see TeamI18n::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildTeamI18nQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TeamI18nTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamI18nTableMap::ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO team_i18n (%s) VALUES (%s)',
    ...
    {
        $pos = TeamI18nTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TeamI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TeamI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = TeamI18nTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(TeamI18nTableMap::DATABASE_NAME);
        $criteria->add(TeamI18nTableMap::ID, $this->id);
        $criteria->add(TeamI18nTableMap::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Team\Model\TeamI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Team\Model\TeamI18n Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(TeamI18nTableMap::DEFAULT_STRING_FORMAT);
    }
